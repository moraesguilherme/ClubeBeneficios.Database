...
GO
ALTER TABLE [dbo].[etl_import_rows]  WITH CHECK ADD  CONSTRAINT [CK_etl_import_rows_status] CHECK  (([status]='error' OR [status]='ignored' OR [status]='processed' OR [status]='pending'))
GO
