...
GO
ALTER TABLE [dbo].[loyalty_rule_sets]  WITH CHECK ADD  CONSTRAINT [CK_loyalty_rule_sets_status] CHECK  (([status]='archived' OR [status]='inactive' OR [status]='active' OR [status]='scheduled' OR [status]='draft'))
GO
