...
GO
ALTER TABLE [dbo].[loyalty_campaign_conditions]  WITH CHECK ADD  CONSTRAINT [CK_loyalty_campaign_conditions_target_level_code] CHECK  (([target_level_code] IS NULL OR ([target_level_code]='diamond' OR [target_level_code]='gold' OR [target_level_code]='silver' OR [target_level_code]='bronze')))
GO
