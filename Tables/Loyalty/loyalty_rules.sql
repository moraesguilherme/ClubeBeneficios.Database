...
GO
ALTER TABLE [dbo].[loyalty_rules]  WITH CHECK ADD  CONSTRAINT [CK_loyalty_rules_status] CHECK  (([status]='archived' OR [status]='inactive' OR [status]='active' OR [status]='scheduled' OR [status]='draft'))
GO
