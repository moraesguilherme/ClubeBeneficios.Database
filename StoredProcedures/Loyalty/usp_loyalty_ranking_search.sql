    ...
    (
        SELECT
            *,
            ...
            (
                ORDER BY
                    CASE WHEN @SortBy = 'ticket_asc' THEN average_ticket_amount END ASC,
                    CASE WHEN @SortBy = 'ticket_desc' THEN average_ticket_amount END DESC,
                    CASE WHEN @SortBy = 'points_asc' THEN available_points END ASC,
                    CASE WHEN @SortBy = 'points_desc' THEN available_points END DESC,
                    ...
                    CASE WHEN @SortBy = 'level_desc' THEN
                        ...
                        END
                    END DESC,
                    average_ticket_amount DESC,
                    available_points DESC,
                    client_name ASC
            )
        FROM Filtered
    )
